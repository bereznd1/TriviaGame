...
var q1 = "<p class='question-text'>What was Tupac's birth name?</p><input type='radio' name='question1' id='q1option1'>Mutulu Shakur<input type='radio' name='question1' id='q1option2'>Tupac Amaru Shakur<input type='radio' name='question1' id='q1option3'>Radric Davis<input type='radio' name='question1' id='q1option4'>Lesane Parish Crooks";

var q2 = "<p class='question-text'>What prison was Tupac incarcerated in on a sexual assault charge?</p><input type='radio' name='question2' id='q2option1'>San Quentin State Prison<input type='radio' name='question2' id='q2option2'>Rikers Island<input type='radio' name='question2' id='q2option3'>Clinton Correctional Facility<input type='radio' name='question2' id='q2option4'>Guantanamo Bay";

var q3 = "<p class='question-text'>What was the first motion picture that Tupac starred in?</p><input type='radio' name='question3' id='q3option1'>Juice<input type='radio' name='question3' id='q3option2'>Above the Rim<input type='radio' name='question3' id='q3option3'>Boyz n the Hood<input type='radio' name='question3' id='q3option4'>Poetic Justice";

var q4 = "<p class='question-text'>What was Tupac's debut solo single?</p><input type='radio' name='question4' id='q4option1'>Trapped<input type='radio' name='question4' id='q4option2'>Brenda's Got A Baby<input type='radio' name='question4' id='q4option3'>If My Homie Calls<input type='radio' name='question4' id='q4option4'>I Get Around";
...
var q6 = "<p class='question-text'>Tupac had a close friendship with the current wife of which famous actor?</p><input type='radio' name='question6' id='q6option1'>Will Smith<input type='radio' name='question6' id='q6option2'>Eddie Murphy<input type='radio' name='question6' id='q6option3'>Denzel Washington<input type='radio' name='question6' id='q6option4'>Martin Lawrence";
